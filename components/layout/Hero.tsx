    ...
    <div className="relative isolate overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16 lg:flex lg:flex-col lg:px-8 lg:py-24">
        ...
        <div className="mx-auto mt-16 max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl bg-neutral-900/5 p-2 ring-1 ring-inset ring-neutral-900/10 lg:rounded-2xl lg:p-4">
            <img
              src="/robot-vcs.png"
              alt="AI VCs evaluating startups"
              className="w-full h-auto rounded-md shadow-2xl ring-1 ring-neutral-900/10"
            />
          </div>
        </div>
      </div>
